...
vim.api.nvim_set_hl(0, "@keyword", { fg = magenta, italic = true })
vim.api.nvim_set_hl(0, "@keyword.modifier", { fg = magenta, italic = true })
...
vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = magenta })
...
vim.api.nvim_set_hl(0, "CmpItemKindFunction", { fg = yellow })
vim.api.nvim_set_hl(0, "CmpItemKindMethod", { fg = yellow })
