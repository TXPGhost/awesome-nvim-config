...
vim.api.nvim_set_hl(0, "DiagnosticInfo", { fg = purple })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", { sp = purple, undercurl = true })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { fg = purple, italic = true })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { fg = green, italic = true })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { fg = orange, italic = true })
