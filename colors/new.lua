...
vim.api.nvim_set_hl(0, "Title", { fg = teal, bold = true, underline = true })
...
vim.api.nvim_set_hl(0, "@markup.heading.markdown", { fg = "#79d1f7", bold = true })
vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", { fg = "#79d1f7", bold = true })
vim.api.nvim_set_hl(0, "@markup.heading.2.markdown", { fg = "#79c8f7", bold = true })
vim.api.nvim_set_hl(0, "@markup.heading.3.markdown", { fg = "#79bef7", bold = true })
vim.api.nvim_set_hl(0, "@markup.heading.4.markdown", { fg = "#7ab5f7", bold = true })
vim.api.nvim_set_hl(0, "@markup.heading.5.markdown", { fg = "#7aabf7", bold = true })
