...
vim.api.nvim_set_hl(0, "Directory", { fg = orange })
...
vim.api.nvim_set_hl(0, "CmpItemAbbrMatch", { fg = member })
...
vim.api.nvim_set_hl(0, "MiniStatuslineModeNormal", { fg = fgg, bg = bggggg, bold = true })
vim.api.nvim_set_hl(0, "MiniStatuslineModeInsert", { fg = fgg, bg = bggggg, bold = true })
vim.api.nvim_set_hl(0, "MiniStatuslineModeVisual", { fg = fgg, bg = bggggg, bold = true })
vim.api.nvim_set_hl(0, "MiniStatuslineModeCommand", { fg = fgg, bg = bggggg, bold = true })
vim.api.nvim_set_hl(0, "MiniStatuslineModeReplace", { fg = fgg, bg = bggggg, bold = true })
vim.api.nvim_set_hl(0, "MiniStatuslineModeOther", { fg = fgg, bg = bggggg, bold = true })
