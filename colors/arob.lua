...
local yellow = "#dfab5c"
local blue = "#7aa2f7"
local other_blue = blue
local red = "#c64640"
local sea = blend(blue, fg, 0.5)
local green = "#8fb573"
local magenta = "#a579f7"
local violet = blend(blue, magenta, 0.5)
...
vim.api.nvim_set_hl(0, "PreProc", { fg = sea })
vim.api.nvim_set_hl(0, "String", { fg = sea })
...
vim.api.nvim_set_hl(0, "@markup.heading.1", { fg = blend(cyan, blue, 0), bold = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.heading.2", { fg = blend(cyan, blue, 0.2), bold = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.heading.3", { fg = blend(cyan, blue, 0.4), bold = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.heading.4", { fg = blend(cyan, blue, 0.6), bold = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.heading.5", { fg = blend(cyan, blue, 0.8), bold = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.heading.6", { fg = blend(cyan, blue, 1), bold = true, underline = true })
...
vim.api.nvim_set_hl(0, "manSubHeading", { bold = true, fg = blend(cyan, blue, 0.5) })
vim.api.nvim_set_hl(0, "manReference", { link = "@markup.link" })

vim.api.nvim_set_hl(0, "LazyH1", { fg = blend(cyan, blue, 0), bold = true })
vim.api.nvim_set_hl(0, "LazyH2", { fg = blend(cyan, blue, 0.2), bold = true })
vim.api.nvim_set_hl(0, "LazyH3", { fg = blend(cyan, blue, 0.4), bold = true })
vim.api.nvim_set_hl(0, "LazyH4", { fg = blend(cyan, blue, 0.6), bold = true })
vim.api.nvim_set_hl(0, "LazyH5", { fg = blend(cyan, blue, 0.8), bold = true })
vim.api.nvim_set_hl(0, "LazyH6", { fg = blend(cyan, blue, 1), bold = true })

vim.api.nvim_set_hl(0, "LazySpecial", { fg = fggg })
vim.api.nvim_set_hl(0, "LazyButton", { fg = sea, bold = true })
