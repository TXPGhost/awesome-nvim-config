...
M.colorscheme = function(colors)
	...
	local heading = colors.heading or string
	...
	vim.api.nvim_set_hl(0, "PmenuSel", { bg = bgggggg, bold = true })
	...
	vim.api.nvim_set_hl(0, "Directory", { fg = heading })
	...
	vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = heading })
	...
	vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { sp = heading, undercurl = true })
	...
	vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { fg = heading, bg = blend(heading, bg, 0.95), italic = true })
	...
	vim.api.nvim_set_hl(0, "@markup.heading", { fg = heading, bold = true })
	vim.api.nvim_set_hl(0, "@markup.heading.1", { fg = blend(red, heading, 0), bold = true, underline = true })
	vim.api.nvim_set_hl(0, "@markup.heading.2", { fg = blend(red, heading, 0.2), bold = true, underline = true })
	vim.api.nvim_set_hl(0, "@markup.heading.3", { fg = blend(red, heading, 0.4), bold = true, underline = true })
	vim.api.nvim_set_hl(0, "@markup.heading.4", { fg = blend(red, heading, 0.6), bold = true, underline = true })
	vim.api.nvim_set_hl(0, "@markup.heading.5", { fg = blend(red, heading, 0.8), bold = true, underline = true })
	vim.api.nvim_set_hl(0, "@markup.heading.6", { fg = blend(red, heading, 1), bold = true, underline = true })
	...
	vim.api.nvim_set_hl(0, "CmpItemAbbr", { fg = fggg })
	vim.api.nvim_set_hl(0, "CmpItemAbbrMatch", { fg = fg })
	...
	vim.api.nvim_set_hl(0, "CmpItemKindSnippet", { fg = constant })
	...
	vim.api.nvim_set_hl(0, "CmpItemKindConstant", { fg = constant })
	vim.api.nvim_set_hl(0, "CmpItemKindEnumMember", { fg = constant })
	...
	vim.api.nvim_set_hl(0, "manSubHeading", { bold = true, fg = blend(red, heading, 0.5) })
	vim.api.nvim_set_hl(0, "manReference", { link = "@markup.link" })

	vim.api.nvim_set_hl(0, "LazyH1", { fg = blend(red, heading, 0), bold = true })
	vim.api.nvim_set_hl(0, "LazyH2", { fg = blend(red, heading, 0.2), bold = true })
	vim.api.nvim_set_hl(0, "LazyH3", { fg = blend(red, heading, 0.4), bold = true })
	vim.api.nvim_set_hl(0, "LazyH4", { fg = blend(red, heading, 0.6), bold = true })
	vim.api.nvim_set_hl(0, "LazyH5", { fg = blend(red, heading, 0.8), bold = true })
	vim.api.nvim_set_hl(0, "LazyH6", { fg = blend(red, heading, 1), bold = true })
